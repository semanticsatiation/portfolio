    ...
    return (
        <>
            <ul className="projects-list">
                <li>
                    <a href="https://bugoff.herokuapp.com/#/login">
                ...
                <li>
                    <a href="https://chess-app-semantic.herokuapp.com/">
                        <h1>Chess Game</h1>
                ...
                <li>
                    <a href="https://maze-solver-semantic.herokuapp.com/">
                ...
                <li>
                    <a href="https://semantic-mine-sweeper.herokuapp.com/">
                ...
                <li>
                    <a href="https://flix-movies.herokuapp.com/">
                        <h1>Movie App</h1>
