...
class Flame extends React.Component {
  render() {
    return (
      ...
      >
        <defs>
          <radialGradient id="carl-olsen-flame-gradient-1">
            <stop offset="0%" stopColor="#e51515"></stop>
            <stop offset="100%" stopColor="#e58f15"></stop>
          </radialGradient>
        </defs>
        <path
          fill="url(#carl-olsen-flame-gradient-1)"
